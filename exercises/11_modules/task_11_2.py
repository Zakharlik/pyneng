...
В словаре, который возвращает функция create_network_map, не должно быть
дублей.

С помощью функции draw_topology из файла draw_network_graph.py нарисовать схему
на основании топологии, полученной с помощью функции create_network_map.
...
parse_cdp_neighbors не может обработать вывод
...
def create_network_map(filenames):
    ...
    for filename in filenames:
        with open(filename) as f:
            neighbors = parse_cdp_neighbors(f.read())
